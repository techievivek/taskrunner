...
def fetch_data():
    ...
    try:
        ...
        try:
            ...
            course_info['start_enroll_time']=response_data['date'] #course start date
            ...
            course_info['end_enroll_time']=response_data['date']+datetime.timedelta (days=course_duration) #course end date
            #Course basic info data is prepared now join with learning module
            course_info.update(json_data) #learnin module data is appended in course_info dict
